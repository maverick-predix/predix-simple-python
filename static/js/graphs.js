d3.queue()
    .defer(d3.json, "/TalkingData/data")
    .await(makeGraphs)
...
function makeGraphs(error, recordsJson) {
    ...
    // Define the dimensions of our crossfilter.
    ...
    var phoneBrandDim = ndx.dimension(function(d) {
    ...
    // Make sure that every time we refilter, we redraw the map.
